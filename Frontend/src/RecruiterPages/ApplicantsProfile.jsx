  ...
  return (
    <div>
      ...
      <motion.div className="flex flex-col md:flex-row w-full min-h-screen p-8 bg-gray-100" initial="hidden" animate="visible" variants={fadeIn}>
        ...
        {/* Right Section */}
        <motion.div className="md:w-1/3 p-6 bg-white rounded-md shadow-lg flex flex-col" variants={{ hidden: { x: 50, opacity: 0 }, visible: { x: 0, opacity: 1, transition: { delay: 0.3, type: 'spring', stiffness: 80, damping: 15 } } }}>
          ...
          <motion.div className="mb-6" variants={staggerContainer} initial="hidden" animate="visible">
            ...
            <motion.div className="flex items-center mb-2" variants={slideUp} whileHover={{ x: 5 }}><FaEnvelope className="w-6 h-6" /><motion.p className="ml-3">{email}</motion.p></motion.div>
            <motion.div className="flex items-center mb-2" variants={slideUp} whileHover={{ x: 5 }}><FaLocationArrow className="w-6 h-6" /><motion.p className="ml-3">{location}</motion.p></motion.div>
          ...
          <motion.button onClick={handleReject} className="w-full mt-auto px-4 py-2 bg-red-600 text-white rounded-md" whileHover={{ scale: 1.05, backgroundColor: '#f87171' }} whileTap={{ scale: 0.95 }}>
            Reject
          </motion.button>
        </motion.div>
      </motion.div>
